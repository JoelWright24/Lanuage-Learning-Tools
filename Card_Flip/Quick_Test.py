...
# Test Rounds
NumberOfRounds= int(input("What Number of rounds do you want: "))

Round_Couter=0
Correct_Number=0

while Round_Couter<NumberOfRounds:
    ...
    Round_Couter=Round_Couter+1      

Percentage_Grade= 100*(Correct_Number/NumberOfRounds)

print("Your overall grade is ",Percentage_Grade,"%")